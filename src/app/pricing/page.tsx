      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Choose the coaching plan that fits your goals and budget. All plans
            include personalized training and ongoing support.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-20">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">
                  What if I need to pause my training?
                </h4>
                <p className="text-gray-600">
                  Life happens! You can pause your subscription for up to 3
                  months if needed due to injury or other circumstances.
                </p>
              </div>
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">
                ...
                <p className="text-gray-600">
                  Yes! Get 15% off when you sign up 2 or more family members for
                  any coaching plan.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-600">
                  Our training platform works on any device - smartphone,
                  tablet, or computer. Compatible with popular running apps and
                  GPS watches.
                </p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-4">
              Try any coaching plan for 30 days. If you&apos;re not completely
              satisfied with your progress and experience, we&apos;ll refund
              your first month - no questions asked.
            </p>
            <p className="text-gray-600">
              We&apos;re confident in our coaching approach and want you to feel
              the same way. Your success is our priority.
            </p>
          </div>
        </div>
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Schedule a free 15-minute consultation to discuss your goals and
            find the perfect coaching plan.
          </p>
          <Link
            href="/contact"
        ...
        <div className="bg-blue-600 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-xl mb-6 opacity-90">
            Join hundreds of runners who have achieved their goals with
