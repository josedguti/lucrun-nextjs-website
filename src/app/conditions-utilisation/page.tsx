        ...
        <div className="prose prose-lg max-w-none mb-16">
          <div className="bg-white rounded-lg p-8">
            <p className="text-gray-600 leading-relaxed text-lg">
              Bienvenue chez Luc Run, votre coach de course à pied. Nous offrons une variété de services de coaching de 
              course à pied, au marathon et trail running. Nos formules sont par mois et adaptées à vos besoins. Nous nous 
              engageons à vous aider à courir sans blessures et à atteindre vos objectifs de course. Nos conditions d&apos;utilisation 
              doivent être respectées par tous nos clients afin de garantir que nous puissions vous fournir les meilleurs services 
              possibles. Nous sommes ravis de vous aider à devenir un coureur plus fort et plus confiant. Contactez-nous pour plus 
              d&apos;informations sur nos formules de coaching et comment nous pouvons vous aider à atteindre vos objectifs de course.
            </p>
          </div>
        </div>
