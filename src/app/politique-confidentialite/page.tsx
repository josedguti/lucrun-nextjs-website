        ...
        <div className="prose prose-lg max-w-none mb-16">
          <div className="bg-white rounded-lg p-8">
            <p className="text-gray-600 leading-relaxed text-lg">
              Luc Run s&apos;engage à protéger la confidentialité de ses clients. Nous respectons votre vie privée et nous nous 
              engageons à protéger les données personnelles que vous nous fournissez. Nous collectons des informations sur nos 
              clients pour mieux comprendre leurs besoins et leur fournir un service personnalisé. Les informations que nous 
              collectons incluent votre nom, adresse, adresse e-mail, numéro de téléphone et informations de paiement. Nous ne 
              partageons pas ces informations avec des tiers sans votre consentement. Toutes les informations que nous collectons 
              sont stockées sur des serveurs sécurisés et sont conservées pendant la durée de votre abonnement. Nous prenons des 
              mesures pour protéger vos informations contre tout accès non autorisé ou toute divulgation. Si nous apportons des 
              modifications à notre politique de confidentialité, nous vous en informerons par e-mail ou en publiant une notification 
              sur notre site. Pour en savoir plus sur notre politique de confidentialité, veuillez nous contacter.
            </p>
          </div>
        </div>
