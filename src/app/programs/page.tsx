      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover the perfect training program tailored to your running goals
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-20">
          <div className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 mb-4">
                Perfect for new runners or those returning to running
              </p>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow border-2 border-blue-600 relative">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 mb-4">
                For runners with 6+ months experience
              </p>
            </div>
            <ul className="space-y-3 mb-6">
              <li className="flex items-center text-gray-600">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 mb-4">
                For experienced runners seeking PRs
              </p>
            </div>
            <ul className="space-y-3 mb-6">
              <li className="flex items-center text-gray-600">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-20">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-600">
                  Personalized training schedule based on your goals and
                  availability
                </span>
              </li>
              <li className="flex items-start">
                ...
                <span className="text-gray-600">
                  Weekly plan adjustments based on your progress and feedback
                </span>
              </li>
              <li className="flex items-start">
                <svg
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-600">
                  Race strategy and pacing recommendations
                </span>
              </li>
              <li className="flex items-start">
                <svg
                ...
                <span className="text-gray-600">
                  Nutrition and hydration guidance for training and racing
                </span>
              </li>
              <li className="flex items-start">
                <svg
                ...
                <span className="text-gray-600">
                  24/7 messaging support for questions and motivation
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-4">
              Our training approach is built on the principle of progressive
              overload while respecting your body&apos;s need for recovery. We
              focus on:
            </p>
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-600">
                  <strong>Gradual progression</strong> to build fitness safely
                </span>
              </li>
              <li className="flex items-start">
                <svg
                ...
                <span className="text-gray-600">
                  <strong>Individual adaptation</strong> to your unique needs
                </span>
              </li>
              <li className="flex items-start">
                <svg
                ...
                <span className="text-gray-600">
                  <strong>Balanced training</strong> across all energy systems
                </span>
              </li>
              <li className="flex items-start">
                <svg
                ...
                <span className="text-gray-600">
                  <strong>Holistic wellness</strong> including rest and recovery
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="bg-blue-600 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-xl mb-6 opacity-90">
            Not sure which program is right for you? Schedule a free
