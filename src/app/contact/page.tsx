      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to start your running journey? Let&apos;s discuss your goals
            and find the perfect training plan for you.
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                consultation call to discuss your goals and get personalized
                recommendations.
              </p>
        ...
        <div className="bg-blue-600 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-xl mb-6 opacity-90">
            Don&apos;t wait any longer. Your personal running transformation
