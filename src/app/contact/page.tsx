...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setSubmitStatus("Merci pour votre message !");
    setFormData({
      firstName: "",
      lastName: "",
      email: "",
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        ...
        <div className="mb-16">
          <div className="relative h-96 rounded-lg overflow-hidden shadow-xl">
            <Image
              src="/lucrun_web_photos/95f704_0e42294ca58e4dbfbe369d6d01627e7e~mv2.avif"
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-20">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-6">
              Remplissez le formulaire pour réserver votre première séance
            </p>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label
                  ...
                  className="block text-sm font-medium text-gray-700 mb-2"
                >
                  Quel programme vous interesse? <span className="text-red-600">*</span>
                </label>
                <select
                  id="program"
                  name="program"
              ...
              <button
                type="submit"
                className="w-full bg-black text-white px-6 py-3 rounded-md font-semibold hover:bg-gray-800 transition-all"
              >
                Envoyer
              </button>
              {submitStatus && (
